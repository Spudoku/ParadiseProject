...
data modify entity @s Item merge value {id:"minecraft:item_frame",Count:1b,tag:{hold:{display:{Name:'{"text":"Forestalling Stone","color":"gold","bold":true,"italic":false}',Lore:['{"text":"Repels spirits in a","italic":false}','{"text":"32 block radius.","italic":false}']}},EntityTag:{id:"minecraft:item_frame",Facing:1b,Invulnerable:1b,Invisible:1b,Silent:1b,Fixed:1b,Tags:["custom_block","unset","ward"],Item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:5}}}}}


#data modify entity @s Item merge value {id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:3},EntityTag:{id:"minecraft:item_frame",Facing:1b,Invulnerable:1b,Invisible:1b,Silent:1b,Fixed:1b,Tags:["custom_block","unset"],Item:{id:"minecraft:stick",Count:1b,tag:{CustomModelData:1}}},ore_item:{id:"minecraft:chain_command_block",Count:36b,tag:{CustomModelData:1,display:{Name:'[{"text":"Levitite Dust","italic":false,"color":"#660066"}]'}}}}}

#,display:{Name:'[{"text":"Block of Levitite","italic":false,"color":"#660066"}]'
#
